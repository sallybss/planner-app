...
import { BudgetRowDef } from "../interfaces/budgetRowDef";

const budgetRowDefSchema = new Schema<BudgetRowDef>(
  {
...
budgetRowDefSchema.pre("findOneAndUpdate", function <T extends Document>(this: any) {
...
export const budgetRowDefModel = model<BudgetRowDef>("BudgetRowDef", budgetRowDefSchema);
